...
| s001 | 11:30 01/09 | leftoverpzero DEV.to | **humano agora:** captcha no VNC (Z-API manda o link). Sign up sparetoken. Um comentário no artigo leftover daily capacity. Copy abaixo. UTM `s0901`. Permalink → `data/sell-proof-url.txt`. | **human-needed** |
...
Texto s001 (colar no artigo, um comentário):
